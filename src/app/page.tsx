      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-32 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="hidden lg:flex justify-center items-center relative">
          ...
          <div className="absolute -bottom-4 -left-4 glass rounded-xl px-4 py-3 animate-float">
            <div className="font-display text-gold text-xl">15K+</div>
            <div className="text-[10px] text-white/50 tracking-wider uppercase">Happy Customers</div>
          </div>
  ...
  return (
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <Image src="https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=1920&h=400&fit=crop&q=60" alt="" fill className="object-cover" />
      </div>
      <div ref={ref} className="reveal relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <a href={`${WHATSAPP_URL}?text=${encodeURIComponent("Hi! I want to place a direct order.")}`} target="_blank" className="btn-wa !px-10 !py-4 text-lg inline-flex items-center gap-2">
  ...
  return (
    <section className="py-16 bg-dark-alt border-y border-white/5">
      <div ref={ref} className="reveal max-w-5xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
        {[
          { end: 15000, suffix: "+", label: "Biryanis Served" },
    ...
    <footer className="bg-dark-alt border-t border-white/5 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {["About", "Menu", "Combos", "Reviews", "Location"].map(l => (
        ...
        <div className="border-t border-white/5 pt-6 text-center text-xs text-white/20">
          © 2025 Pothuraju Biryani. All rights reserved. | Kondapur, Hyderabad | Built with ❤️
        </div>
      </div>
    </footer>
  );
...
function FloatingButtons() {
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
      <a href={WHATSAPP_URL} target="_blank" className="w-14 h-14 rounded-full bg-whatsapp flex items-center justify-center text-2xl shadow-lg shadow-whatsapp/30 hover:scale-110 transition-transform" title="WhatsApp">
        💬
      </a>
      <a href={`tel:+${PHONE}`} className="w-14 h-14 rounded-full bg-brand flex items-center justify-center text-2xl shadow-lg shadow-brand/30 hover:scale-110 transition-transform" title="Call">
        📞
      </a>
    </div>
  );
